...
import { Center, HStack, VStack, Stack, Pressable, Divider, useToast, Spinner, Box } from 'native-base';
...
import { RiderOrderHistoryModel } from '../models/get-rider-history';
import { connect } from 'react-redux';
import { RideOrderToView, Riderstate } from '../../redux';
import { RefreshIcon } from '../components/icons';
const Colors = Color()
function RiderOrderHistory({ navigation, appState, setRiderState, setRideToView }) {
    ...
    function FetchHistory() {
        setloading(true)
        RiderOrderHistoryModel(User.id)
            .then(response => {
...
export default connect(mapStateToProps, mapDispatchToProps)(RiderOrderHistory);
